...
if(argv.basin !== undefined){
    ...
    airbasins = _.flatten([small_basins,big_basins])
}
...
function setup_R_job(o,done){
    ...
    var logfile = 'log/'+basin+'_'+year+'_'+month+'_'+day+'.log'
...
_.each(years,function(year){
    _.each(airbasins,function(basin){
        var endymd = new Date(year+1, 0, 0, 0, 0, 0)
        for( var ymd = new Date(year, startmonth, 0, 0, 0, 0);
             ymd < endymd;
